...
public class RightFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.right_fragment_layout, null);
        lv = (PullToRefreshListView) view.findViewById(R.id.recylerView_right);
                        ...
                        if (response!=null){
                            ...
                            try {
                                ...
                                if (a==1){
                                    ...
                                    Toast.makeText(RightFragment.this.getContext(),"网络等异常",Toast.LENGTH_SHORT).show();
                                }
